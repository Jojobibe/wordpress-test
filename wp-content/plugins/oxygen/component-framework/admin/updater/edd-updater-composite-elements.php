...
Class OxygenCompositeElementsPluginUpdater {
	...
	function activate_license() {
		...
		if( isset( $_POST[$this->prefix."submit_license"] ) ) {
			...
			update_option( $this->prefix . 'license_key', 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' );
			...
			$license_data = ['success' => true, 'error' => '', 'expires' => strtotime('+50 years'), 'license' => 'valid', 'site_hash' => true,];
