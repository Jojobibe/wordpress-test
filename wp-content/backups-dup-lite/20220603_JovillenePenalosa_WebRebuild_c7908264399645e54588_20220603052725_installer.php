...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220603_JovillenePenalosa_WebRebuild_c7908264399645e54588_20220603052725_archive.zip';
	const ARCHIVE_SIZE		 = '101902871';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c790826-03052725';
    const SECONDARY_PACKAGE_HASH = 'd2c30b1-03052725';
	const VERSION			 = '1.4.6';
